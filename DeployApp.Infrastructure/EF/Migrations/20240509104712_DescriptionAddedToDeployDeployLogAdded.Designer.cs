...
namespace DeployApp.Infrastructure.EF.Migrations
{
    ...
    [Migration("20240509104712_DescriptionAddedToDeployDeployLogAdded")]
    partial class DescriptionAddedToDeployDeployLogAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeployApp.Domain.Entities.DeployLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("DeployId", "InstanceId");

                    b.ToTable("deploy_log_102", (string)null);
                });
            ...
            modelBuilder.Entity("DeployApp.Domain.Entities.DeployLog", b =>
                {
                    b.HasOne("DeployApp.Domain.Entities.DeployInstance", "DeployInstance")
                        .WithMany("DeployLogs")
                        .HasForeignKey("DeployId", "InstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeployInstance");
                });
